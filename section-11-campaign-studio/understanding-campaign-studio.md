...
![Understanding Campaign Studio — Brande.ai](./images/understanding-campaign-studio.jpg)
...
Look for the campaign icon <img src="./images/ic-outline-campaign.svg" width="20" height="20" alt="Campaigns icon" style="display:inline;"> in the top navigation bar (hover it to see the "Campaigns" tooltip). It opens the Campaigns page, showing your active campaigns, how many blueprint-ready campaigns you have, and your monthly campaign-run usage against your plan.
