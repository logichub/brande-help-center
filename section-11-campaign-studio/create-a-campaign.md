...
![Create a Campaign — Brande.ai](./images/create-a-campaign.jpg)


## Access Campaign Studio

Click the campaign icon <img src="./images/ic-outline-campaign.svg" width="20" height="20"> in the topbar navigation — hover it to see the "Campaign Studio" tooltip. You'll land on the Campaigns page.
...
- **URLs to analyze** (optional) — pages you want the research sprint to consider
